...
testObject (ObjTestParams { objTestOpts, objTestPath, objTestPred }) = testWrap' "Object test" objTestPath $ \scm -> do
...
testInvalidObject (ObjTestParams {objTestOpts, objTestPath, objTestPred}) = testWrap' "Invalid Object test" objTestPath $ \scm -> do
